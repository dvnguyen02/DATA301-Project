...
Lycopene intake is 10.1% higher in those with a history of kidney stones. Some research suggests that lycopene may have protective effects against kidney stone formation due to its antioxidant properties (Yencilek et al., 2010), which makes this finding particularly interesting.

Vitamin C intake is 8.4% lower in individuals who have had kidney stones. This aligns with some studies suggesting that high-dose vitamin C supplementation may increase kidney stone risk (Thomas et al., 2013), potentially leading to reduced intake in those with a history of stones.
...
```
Figure 8: a) Kidney stone prevalence and smoking at least 100 cigarettes in life b) Kidney stone prevalence and the number of prescriptions taken. c) Kidney stone prevalence and trouble sleeping. 

In Figure 8a, the proportion of people who have kidney stone or not for people with some certain characteristics(smoke more then 1000 time in their life,smoke less then 1000 time in their life, don’t know and refuse to answer) can be seen. The prevalence of kidney stones for people who have smoked at least 100 cigarettes in their life is higher then who have not. From this, it show the correlation between risk of kidney stone and smoking, and backs up research showing correlation between smoking and risk of kidney stones. 

Figure 8b shows the average the number of prescriptions taken by those who have had kidney stones, and those who have not. We can see that people who have kidney stones tend to have higher number of prescriptions taken, compared to people who have never had kidney stones. From this, it show the correlation between risk of kidney Stones and number of prescriptions taken, and backs up research indicating causation between kidney stone occurance and number of prescriptions taken. 

In Figure 8c, the proportion of people who have kidney stones and those who do not are shown against people who have a sleeping issue, don’t have a sleeping issue, don’t know and refused to answer. The proportion of kidney stones for people who answer yes (have sleeping issue) is higher than those who answer no (no sleeping issue). From this, it shows the correlation between risk of kidney stones and smoking, and backs up research linking risk of kidney stones to sleeping issues.

# 4. Individual Contributions

Brook:

* Sections 2.1 to 2.2: Ethical Considerations and Privacy Concerns
* Section 3.3: Lab Analysis (Figure 4g and associated text)
...
* Sections 3.1 to 3.3: Demographics Analysis, Health Conditions Analysis, Lab Analysis (Figures 1 - 4f and associated text)

Thinh:

* Section 3.6: Risk Factor Analysis (Figure 8 and associated text)

David:

* Section 2.3: Security Measures (data handling and storage)
* Section 3.4: Dietary Analysis (Figure 5 and associated text)
* Section 3.5: Physical Activity Analysis (Figure 6 and associated text) 
