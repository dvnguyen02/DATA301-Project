...
group_members <- data.frame(
  Name = c("Brook (lastname)", "Katie Chu-Fong", "Thinh (lastname)", "David Nguyen"),
  `Student ID` = c("12345678", "300601174", "11223344", "300584723")
)
...
Is kidney stone prevalence associated with factors such as diet, lifestyle, and other existing medical conditions? Kidney stones are solid deposits that develop in the urinary tract, and can cause blockage and severe pain when urine is passed (National Institutes of Health, n.d.). A previous study by Abufaraj et al. (2020) indicates it is a common condition that affects approximately 10% of people at least once in their lifetime, and in some cases may require significant and/or recurrent treatment. 
